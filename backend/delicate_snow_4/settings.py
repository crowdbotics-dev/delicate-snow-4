"""
Django settings for delicate_snow_4 project.
...
ROOT_URLCONF = 'delicate_snow_4.urls'
...
WSGI_APPLICATION = 'delicate_snow_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Delicate Snow Support <support@delicate-snow-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_snow_4 API",
    "DESCRIPTION": "API documentation for delicate_snow_4 App",
    "VERSION": "v1",
}
